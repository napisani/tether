...
`src/gtk/` is the reference for feature boundaries, terminology, navigation,
and lifecycle behavior. `web/AGENTS.md` defines the source-layout and naming
rules that preserve those correspondences.
...
| GTK module | Web module |
|---|---|
| `main.cpp` | `web/ui/src/app/TetherApp.tsx`, `AppShell.tsx` |
| `daemon_client.cpp` | `web/ui/src/daemon/DaemonClient.ts` |
| `devices_view.cpp` | `web/ui/src/views/devices/DevicesView.tsx` |
| `messages_view.cpp` | `web/ui/src/views/messages/MessagesView.tsx` |
| `notifications_view.cpp` | `web/ui/src/views/notifications/NotificationsView.tsx` |
| `calls_view.cpp` | `web/ui/src/views/calls/CallsView.tsx` |
| `contacts_view.cpp` | `web/ui/src/views/contacts/ContactsView.tsx` |
| `settings_view.cpp` | `web/ui/src/views/settings/SettingsView.tsx` |
| `contact_completion.cpp` | shared contact-completion component or hook |
| `message_format.cpp` | shared message-formatting module |
| `prefs.cpp` | shared browser-preferences module |
| `ui_util.cpp` | app shell and shared presentation utilities |
